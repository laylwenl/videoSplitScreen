...
export function getLayoutPositions(layoutType: string): VideoPosition[] {
  ...
  const positions: Record<string, VideoPosition[]> = {
    ...
    '7': [
      ...
      // 右下：4个小视频（各占1x1）
      { col: 3, colSpan: 1, row: 3, rowSpan: 1 }, // 小视频4
      { col: 4, colSpan: 1, row: 3, rowSpan: 1 }, // 小视频5
      { col: 3, colSpan: 1, row: 4, rowSpan: 1 }, // 小视频6
      { col: 4, colSpan: 1, row: 4, rowSpan: 1 }  // 小视频7
    ],
    '8': [
      // 左上：大视频（占据3列3行）
